const RunesStar = ({ setCurrentRune, currentRune, runeSetSubset }) => {
  return (
    <div className="relative w-96 h-96 border-2 border-black m-4">
      {/* Circle 1 (Top) */}
      <div
        className={`absolute flex items-center justify-center w-20 h-20 bg-blue-800 rounded-full left-1/2 top-8 -translate-x-1/2 cursor-pointer hover:drop-shadow-[0_0_15px_rgba(255,255,255,0.2)] ${
      ...
      {/* Circle 2 (Top Right) */}
      <div
        className={`absolute flex items-center justify-center w-20 h-20 bg-blue-800 rounded-full right-12 top-1/4 cursor-pointer hover:drop-shadow-[0_0_15px_rgba(255,255,255,0.2)] ${
      ...
      <div
        className={`absolute flex items-center justify-center w-20 h-20 bg-blue-800 rounded-full right-12 bottom-1/4 cursor-pointer hover:drop-shadow-[0_0_15px_rgba(255,255,255,0.2)] ${
      ...
      {/* Circle 4 (Bottom) */}
      <div
        className={`absolute flex items-center justify-center w-20 h-20 bg-blue-800 rounded-full left-1/2 bottom-8 -translate-x-1/2 cursor-pointer hover:drop-shadow-[0_0_15px_rgba(255,255,255,0.2)] ${
      ...
      <div
        className={`absolute flex items-center justify-center w-20 h-20 bg-blue-800 rounded-full left-12 bottom-1/4 cursor-pointer hover:drop-shadow-[0_0_15px_rgba(255,255,255,0.2)] ${
      ...
      {/* Circle 6 (Top Left) */}
      <div
        className={`absolute flex items-center justify-center w-20 h-20 bg-blue-800 rounded-full left-12 top-1/4 cursor-pointer hover:drop-shadow-[0_0_15px_rgba(255,255,255,0.2)] ${
